Alias: $EHMIAuditEventTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-types
Alias: $EHMIAuditEventSubTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-sub-types
Alias: $EHMIAuditEventSubTypesValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-sub-types
Alias: $EHMIAuditEventOutcome = http://hl7.org/fhir/audit-event-outcome
Alias: $EHMIAuditEventSourceType = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-source-type
Alias: $EHMIAuditEventParticipationRoleType = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-participationroletype
Alias: $EHMIAuditEventAgentWhoIdentifierTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-agent-who-identifier-types
Alias: $EHMIAuditEventEntityType = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-entity-type
Alias: $EHMIAuditEventEntityDetailType = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-entity-detail-type
...
Alias: $EHMIAuditEventEntityMessageType = http://medcomehmi.dk/ig/dk-medcom-ehmi-eds-r5/CodeSystem/ehmi-auditevent-entity-message-type
